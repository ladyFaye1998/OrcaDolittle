...
<tr>
<td width="50%"><img src="figures/calltype_compositionality.png" alt="Compositional structure beyond first order" /><br/><sub><b>Beyond first order (H7).</b> SRKW S-calls exceed first-order Markov surrogates (&Delta; = 0.645 bits, p &asymp; 1e-3; candidate phrase S01&rarr;S04&rarr;S01); null in NRKW, reported honestly. A combinatorial prerequisite, not meaning.</sub></td>
