...
against a $0.050$ label-shuffle null ($p=10^{-3}$): the encoder represents the dialect space
that drives the response, corroborated across independent broadcast-response datasets
...
Kamchatka dialect call types that drive the response (purity $0.439$ vs.\ a $0.05$ null). The
