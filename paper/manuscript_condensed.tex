...
bouting). The stronger combinatorial prerequisite the comparative literature tests for
\citep{sharma2024,berthet2025bonobo,crockford2025}; reported honestly both ways and still not
...
``more than one context'' criterion holds well beyond movement state
...
five shared types. Representation stability, not semantic meaning.
