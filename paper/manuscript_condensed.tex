...
causal-attribution and negative-control battery, and an embedding-based playback-response
model, all built around one frozen encoder so every result is attributable to the
representation under a single auditable protocol.
