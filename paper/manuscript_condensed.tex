...
selectivity and rate/loudness/echolocation controls \citep{holt2024masking_data}. The work
is fully non-invasive and makes no claim of meaning or of a response to broadcast signals;
it establishes the production-side prerequisites and the site-controlled baseline on which
interactive playback studies can build.
\end{abstract}
...
of field data and in-situ playbacks \citep{sayigh2025nsw}.
...
loudness control ($0.577$) argue against a pure-arousal account. \emph{Calibrated
...
movement-defined context, individual held out; \textbf{no claim}: referential meaning, the
perception side, or any response to a broadcast signal, which require field playbacks an
archival corpus cannot supply \citep{deecke2005,sayigh2025nsw}.
